...
int ll_len(LinkedList* this)
{
    ...
    if (this != NULL)
    {
    	returnAux = this -> size; //tomo el tamaño de la lista
    }
    return returnAux;
}
...
int ll_indexOf(LinkedList* this, void* pElement)
{
    ...
    if (this != NULL)
    {
    	lenList = ll_len(this); //tomo el tamaño de la lista
...
int ll_isEmpty(LinkedList* this)
{
    ...
    if (this != NULL)
    {
    	lenList = ll_len(this); //obtengo el tamaño de la lista
    	returnAux = 1;
...
int ll_containsAll(LinkedList* this,LinkedList* this2)
{
    ...
    {
    	lenList = ll_len(this2); // miro el tamaño de la lista 2
    	returnAux = 1;
...
LinkedList* ll_subList(LinkedList* this,int from,int to)
{
    ...
    if (this != NULL)
    {
    	lenList = ll_len(this); //tomo el tamaño
