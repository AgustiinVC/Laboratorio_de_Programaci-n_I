...
{	puts ("~~~~~~~~~~~~~~~~~~~~~~~~~");
	puts ("--Parcial N°2--");
	puts ("--!Estamos en el año 1990¡--\n");
	puts ("--SALON--");
	puts ("1. Alta del salon");
	puts ("2. Eliminar salon");
	puts ("3. Listar salon\n");
	puts ("--ARCADE--");
	puts ("4. Incorporar arcade");
	puts ("5. Modificar arcade");
	puts ("6. Eliminar arcade");
	puts ("7. Imprimir arcade\n");
	puts ("--JUEGO--");
	puts ("8. Agregar juego");
	puts ("9. Imprimir juego\n");
	puts ("--INFORMES--");
	puts ("10. Ver menu Informes");
	puts ("11. Salir");
	puts ("~~~~~~~~~~~~~~~~~~~~~~~~~");
}
...
{	puts ("~~~~~~~~~~~~~~~~~~~~~~~~~");
	puts ("--INFORMES--");
	puts ("--!Estamos en el año 1990¡--\n");
	puts ("A. Listar los salones con mas de 4 arcade. Indicando ID de salon, nombre, direccion y tipo de salon.");
	puts ("B. Listar los arcade para mas de 2 jugadores, indicando ID de arcade, cantidad de jugadores, nombre del juego, su genero y nombre del salon al que pertenece.");
	puts ("C. Listar toda la informacion de un salon en especifico ingresado por el usuario. Imprimir ID de salon, nombre, tipo y direccion.");
	puts ("D. Un salon se encuentra completo si posee al menos 4 juegos del genero plataforma, 3 del genero laberinto y 5 del géeero Aventura. Listar los salones que cumplan con este minimo de requisito.");
