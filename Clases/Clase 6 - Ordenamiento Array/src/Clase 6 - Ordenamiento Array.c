	...
	do
	{
		...
		switch (opcionIngresada)
		{
			...
			case 4:
				...
				break;
			case 5:
				ordenInsercionIntAsc (arrayNros, ARRAY_MAX);
				imprimirArrayInt ("El array de numeros se ordeno y quedo de la siguiente manera:" ,arrayNros, ARRAY_MAX);
				break;
			case 6:
