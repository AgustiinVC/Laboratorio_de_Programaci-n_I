...
int tra_altaForzadaArray(Producto* list, int len, int idProducto, int idComprador, int idVendedor, int costo, int cantidad, int distanciaKM, long int horaLLegada)
{
	int rtn = -1;
	int indiceLibre;
